...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 149760, PLL_3,    5, 2,  61440000,  775, VDD_RAW(775) },
	{ 1, 245760, PLL_3, 5, 2, 61440000, 800, VDD_RAW(800) },
	{ 1, 368640, PLL_3, 5, 1, 122800000, 825, VDD_RAW(825) },
	{ 1, 480000, PLL_2,    3, 0,  122800000, 850, VDD_RAW(825), &pll2_tbl[0] },
	{ 1, 544000, PLL_2,    3, 0,  122800000, 875, VDD_RAW(875), &pll2_tbl[1] },
    { 1, 600000, PLL_2,    3, 0,  122800000, 925, VDD_RAW(925), &pll2_tbl[2] },   
	{ 1, 768000, PLL_1,    2, 0,  153600000, 975, VDD_RAW(975) },
	{ 1, 806400,  PLL_2, 3, 0, UINT_MAX, 1025, VDD_RAW(1025), &pll2_tbl[3]},
	{ 1, 921600,  PLL_2, 3, 0, UINT_MAX, 1025, VDD_RAW(1025), &pll2_tbl[4]},
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1100), &pll2_tbl[5]},
	{ 1, 1113000, PLL_2, 3, 0, UINT_MAX, 1125, VDD_RAW(1125), &pll2_tbl[6]},
	{ 1, 1200000, PLL_2, 3, 0, UINT_MAX, 1150, VDD_RAW(1150), &pll2_tbl[7]},
	{ 1, 1305600, PLL_2, 3, 0, UINT_MAX, 1175, VDD_RAW(1175), &pll2_tbl[8]},
	{ 1, 1401600, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1200), &pll2_tbl[9]},
	{ 1, 1497600, PLL_2, 3, 0, UINT_MAX, 1225, VDD_RAW(1225), &pll2_tbl[10]},
	{ 1, 1516800, PLL_2, 3, 0, UINT_MAX, 1250, VDD_RAW(1250), &pll2_tbl[11]},
	{ 1, 1612800, PLL_2, 3, 0, UINT_MAX, 1275, VDD_RAW(1275), &pll2_tbl[12]},
	{ 1, 1708800, PLL_2, 3, 0, UINT_MAX, 1300, VDD_RAW(1300), &pll2_tbl[13]},
	{ 1, 1804800, PLL_2, 3, 0, UINT_MAX, 1325, VDD_RAW(1325), &pll2_tbl[14]},
	{ 0 }
};
